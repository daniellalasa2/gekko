...
method.check = function() {
    ...
    if (true || haspredicted && predictioncount > 1000) {
        ...
        */
        ...
        } else if ((oversold && (buyprice - this.HACandle.xclose) / buyprice > stop_loss) || ((global.sig0 === true && percentvar + 0.5 < -0.90 || (global.sig0RSI === false && this.indicators.rsi.result > rsi_high) || (Price >= BB.upper)) && (hasbought))) {
