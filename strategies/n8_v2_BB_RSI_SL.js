...
method.check = function(candle) {
    ...
    if (haspredicted & predictioncount > 1000) {
        ...
        } else if ((oversold === true && this.SLActive && buytime > this.settings.thresholds.low && hasbought === true) || (global.sig0 === true && percentvar < top && hasbought === true) || ((hasbought === true && this.indicators.rsi.result > this.settings.thresholds.high && StochRSIsaysSELL) && this.SLActive) || (Price >= BB.upper)) {
